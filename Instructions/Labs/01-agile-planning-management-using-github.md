...
> **Note:** For this and subsequent labs, you will need a GitHub account. We strongly recommend creating a separate account to use in the labs. To create a GitHub account, follow instructions in the article [Creating an account on GitHub](https://docs.github.com/en/get-started/quickstart/creating-an-account-on-github).
...
1. On the **Create a new repository** page, perform the following actions:
   ...
   > **Note:** To learn more about .gitignore, refer to [Ignoring files](https://docs.github.com/en/get-started/getting-started-with-git/ignoring-files).

   - In the **Choose a license** drop-down list, select **MIT**.

   > **Note:** To learn more about license selections, refer to [Licensing a repository](https://docs.github.com/en/repositories/managing-your-repositorys-settings-and-features/customizing-your-repository/licensing-a-repository).
...
1. On the **New milestone** page, perform the following actions:
   ...
   - In the **Title** text box, enter **beta release**.
   - In the **Due date (optional)** text box, enter the date one week ahead from the current date.
   - In the **Description** text box, enter **Completion of beta release**.

1. Select **Create milestone**.
1. Repeat the last three steps to create an **alpha release** milestone with the due date two weeks ahead of the current date.
1. Navigate back to the **Welcome to issues!** page and select **New issue**.
...
1. Select the gear icon next to the **Milestone** entry and, in the drop-down list, select **beta release**.
...
1. In the **Short description** text box, enter **Introduction to Project boards** and select **Save**.
1. In the **README** section, enter the following text
   ...
   **Projects are a customizable, flexible tool for planning and tracking your work.**
   ...
   To find out more, refer to GitHub documentation [about Projects](https://docs.github.com/en/issues/planning-and-tracking-with-projects/learning-about-projects/about-projects).
   ```
...
1. Select **Add milestone** and, in the **Select an item** drop-down list, select **beta release**.
...
1. Note that closing the item resulted in the following actions:
   ...
   - **beta release** milestone has been marked as complete, as indicated by the green horizontal bar in the **Milestone** section of the page.
